...
class VectorStore(ABC):
    ...
    def from_documents(
        ...
        **kwargs: Any,
        ...
        # Wrap the iterable with tqdm for progress monitoring
        tqdm_documents = tqdm(documents, desc="Processing documents")
        
        # Update the loop to use tqdm_documents instead of documents
        return cls.from_texts([d.page_content for d in tqdm_documents], embedding, metadatas=metadatas, **kwargs)
